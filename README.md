...
| AI·해커톤 에너지형 | AI 밋업, 데모데이, 해커톤, 개발자 컨퍼런스, 팀 빌딩 행사 | 팀, 트랙, 프로젝트/데모 키워드, 기술 관심사 | name, company, role, track, interests | 기본 탐사 A4 8칸 라벨지 | 높음 — 진한 배경과 그라디언트 때문에 대량 인쇄 전 테스트 권장 |
...
```text
잠깐! 이 스킬을 통해 행사용 네임택을 인쇄하려면 탐사 A4 8칸 라벨지 (99mm x 67.5mm)가 필요해요.
오늘 주문하면 내일 받아 바로 출력할 수 있어요. 어떻게 진행할까요?
